...
def main():
    ...
    print(f"MACHINE_ID: {MACHINE_ID}, TOTAL_MACHINES: {TOTAL_MACHINES}, DOWNLOAD_DIR: {DOWNLOAD_DIR}, MAX_BATCHES_ON_DISK: {MAX_BATCHES_ON_DISK}, DOWNLOAD_THREADS: {DOWNLOAD_THREADS}, BATCH_SIZE: {BATCH_SIZE}, REPORT_DIR: {REPORT_DIR}")
